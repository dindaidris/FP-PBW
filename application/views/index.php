...
<html lang="en">
    <head>
        ...
        <title>Nyoba.</title>
        <!-- Favicon -->
        <link rel="shortcut icon" href="assets/img/n.ico">
        ...
        <!-- Datepicker -->
        <link rel="stylesheet" href="assets/css/timepicki.min.css">
        <!-- Owl Carousel -->
        <link rel="stylesheet" href="assets/css/owl.carousel.min.css">
        <!-- Custom CSS -->
        <link rel="stylesheet" href="assets/css/style.default.css">
        <!-- Modernizr -->
        <script type="text/javascript" src="assets/js/modernizr.custom.79639.min.js"></script>
    </head>
    <body>
        ...
        <div class="page-holder">
            ...
            <header class="header">
                <nav class="navbar navbar-default navbar-fixed-top">
                    <div class="container">
                        <div class="navbar-header"><a href="index.php" class="navbar-brand"><img src="assets/img/logo.png" alt="Italiano" width="100"></a>
                    ...
                    <div class="sl-slider">
                        ...
                        <div class="sl-slide bg-1" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
                            <div class="sl-slide-inner" style="background-image: url(assets/img/hero-bg.jpg);">
                                <div class="container">
                                    <h2>This is <span class="text-primary">Nyoba</span>.</h2>
                                    <h1>Tagline Nyoba.</h1>
                                    <p>Ayo cobain Nyoba. <a href="https://www.google.com/maps/place/Jl.+Wisma+Permai+XI+No.5,+Mulyorejo,+Kota+SBY,+Jawa+Timur+60115/@-7.274477,112.7912025,19z/data=!3m1!4b1!4m5!3m4!1s0x2dd7fa17585fc2b9:0x9ee64569827b95bb!8m2!3d-7.274477!4d112.791751" target="_blank">ada disini loh</a>.</p>
                                </div>
                            </div>
                        </div>
                        <!-- slide -->
                        <div class="sl-slide bg-2" data-orientation="vertical" data-slice1-rotation="10" data-slice2-rotation="-15" data-slice1-scale="1.5" data-slice2-scale="1.5">
                            <div class="sl-slide-inner" style="background-image: url(assets/img/hero-bg02.jpg);">
                                <div class="container">
                                    <h1>Coba <span class="text-primary">Nyoba</span>. yuk!</h1>
                                    <p>Penjelasan coba ada disini, atau sambungannya Tagline hehehehe.</p>
                                </div>
                            </div>
                        </div>
                        <!-- slide -->
                        <div class="sl-slide bg-3" data-orientation="horizontal" data-slice1-rotation="3" data-slice2-rotation="3" data-slice1-scale="2" data-slice2-scale="1">
                            <div class="sl-slide-inner" style="background-image: url(assets/img/hero-bg03.jpg);">
                                <div class="container">
                                    <h2>Visit <span class="text-primary">Nyoba</span>.</h2>
                                    <h1>Sebuah Tagline</h1>
                                    <p>Penjelasan Tagline ada disini, atau sambungannya Tagline hehehehe.</p>
                                </div>
                            </div>
                        </div>
                    </div><!-- End sl-slider -->
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <a href="tel:+6281294394337" class="phone">+62 812 9439 4337</a>
                        </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <a href="https://www.google.co.id/search?ei=ZH7hWpigE6CcvQSPyaDgDw&q=postocoffee&oq=postocoffee&gs_l=psy-ab.3..0i13k1l4j0i13i30k1l4j0i13i10i30k1l2.3645.5149.0.5421.6.6.0.0.0.0.114.531.5j1.6.0....0...1.1.64.psy-ab..0.4.374...0i10i203k1j0i203k1j0i10i30k1j0i13i10k1.0.5isoUB8QA9s#lrd=0x2dd7fa1cf963db0f:0xcc3cf217ba858c1f,1,,," class="reviews btn-unique" target="_blank"><i class="fa fa-angle-right"></i></a>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section id="about" class="about">
                <div class="container text-center">
                    ...
                    <p class="lead">Nyoba. adalah sebuah restoran, yang dibuat dari tahun 2017. Nyoba sendiri udah banyak tempatnya, ada disini disana sama disitu. Awalnya buat cuma dua orang, tapi lama-lama bisa berjalan nambah staff dan lain-lainnya seiring berjalannya waktu. Terus Nyoba. sendiri ditujukan buat anak tua muda yang mau nongkrong. Buat kumpul-kumpul juga bisa, dibooking dulu tempatnya kalo rame-rame. gitu sih. </p>
                </div>
            </section>
            <!-- End About Section -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 service">
                            ...
                            <div class="text">
                                ...
                                <p>Temapat nya yang nyaman, bersih, dan pewe jadi enak buat nongki nongki.</p>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4 service">
                            ...
                            <div class="text">
                                ...
                                <p>Makanan yang dibuat dari Chef yang keren bro! jadi udah pasti enak. Dijamin!</p>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4 service">
                            ...
                            <div class="text">
                                ...
                                <p>Udah pasti dibuat dari bahan-bahan yang Baru dan Fresh lah! Jadi tambah enak makannya.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section id="app" class="app">
                <div class="container text-center has-border">
                    <h5>Ayo cobain Nyoba. Cafe! jangan sampe gak dapet tempat duduk! Buru Reservasi!</h5>
                    <ul class="list-unstyled list-inline">
                        <!-- <li><a href="https://bootstraptemple.com/" target="_blank" title="Google Play" class="btn-unique-white">Google Play</a></li>
                        <li><a href="https://bootstraptemple.com/" target="_blank" title="Appstore" class="btn-unique-white">App Store</a></li> (ini backup asli)-->
                        <li><a href="#booking" title="Bootstrap Temple" class="btn-unique-white">Make A Reservation</a></li>
                    </ul>
                </div>
            </section>
            <!-- End App Section -->
            ...
            <section id="dishes" class="dishes">
                <div class="container text-center">
                    ...
                    <div class="owl-carousel owl-theme">
                        ...
                        <div class="dish">
                            <div class="profile">
                                <img src="assets/img/signature-dish.png" class="img-responsive" alt="dish name">
                                <div class="price">
                                    <span>3$</span>
                                </div>
                            </div>
                            <div class="text">
                                <h4>Mie Goreng</h4>
                                <p>Dibuat dari Mie Goreng Instan pilihan dicampur dengan bumbu-bumbu yang sudah ada, jadi pasti enak, mengenyangkan, dan bikin nagih.</p>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="item">
                                ...
                                <div class="profile">
                                    <img src="assets/img/special-offer.png" alt="dish name" class="img-responsive">
                                </div>
                                <div class="text">
                                    <h4>Rokok</h4>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-4 brief">
                            ...
                            <p>Ayo jangan ragu buat coba Nyoba. tempat enak, makanan enak, harga juga enak. Nunggu apalagi? Yuk Yuk Yuk ke Nyoba. Sekarang. Kalo butuh nih sebelah kanan ada kontak nyah.</p>
                        </div>
                        ...
                        <div class="col-md-4 contact">
                            ...
                            <ul class="contact list-unstyled">
                                <li><span class="icon-map text-primary"></span>Wisma Permai XI, Surabaya</li>
                                <li><a href="mailto:Italiano@Company.com"><span class="icon-phone text-primary"></span>Nyoba@mail.com</a></li>
                                <li><span class="icon-mail text-primary"></span>+62 812 9439 4337</li>
                                <li><span class="icon-printer text-primary"></span>+62 812 9439 4337</li>
                            </ul>
                        </div>
                        ...
                        <div class="col-md-4 newsletter">
                            ...
                            <p>Nih tarok email disinih, kalo mau update nyang baru baru.</p>
